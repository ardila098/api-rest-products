...
exports.reciveWebhook = exports.proccesPayment = exports.createOrders = void 0;
var _mercadopago = _interopRequireDefault(require("mercadopago"));
var _Orders = _interopRequireDefault(require("../../models/orders/Orders"));
var _sentEmails = require("../sentEmails.controller");
...
var proccesPayment = exports.proccesPayment = /*#__PURE__*/function () {
  ...
  return function proccesPayment(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var reciveWebhook = exports.reciveWebhook = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 21:
          ...
          (0, _sentEmails.sentEmails)(dataEmail);
          return _context2.abrupt("return", res.status(201).json(updatedOrder));
        case 25:
          _context2.next = 31;
          break;
        case 27:
  ...
  return function reciveWebhook(_x3, _x4) {
...
var createOrders = exports.createOrders = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          console.log(req.body);
          newOrder = new _Orders["default"](req.body);
          _context3.prev = 2;
          _context3.next = 5;
          return newOrder.save();
        case 5:
          savedOrder = _context3.sent;
        ...
        case 9:
          ...
          console.error("Error saving order:", _context3.t0);
          res.status(500).json({
  ...
  return function createOrders(_x5, _x6) {
