...
exports.verifySession = exports.signup = exports.signin = void 0;
      ...
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 10:
          ...
          res.cookie("token", token, {
            ...
            sameSite: 'None',
            secure: false,
            // Solo usar en HTTPS en producción
...
var verifySession = exports.verifySession = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          _context3.prev = 4;
          // Verificar el token
          decoded = _jsonwebtoken["default"].verify(token, _config["default"].SECRET); // Buscar al usuario y poblar los roles
          _context3.next = 8;
          return _User["default"].findById(decoded.id).populate("roles");
        case 8:
          user = _context3.sent;
          if (user) {
            _context3.next = 11;
        ...
        case 14:
          ...
          if (!(_context3.t0 instanceof _jsonwebtoken["default"].JsonWebTokenError)) {
            _context3.next = 18;
            break;
          }
        ...
        case 18:
          ...
          console.error("Error verifying session:", _context3.t0);
          res.status(500).json({
  ...
  return function verifySession(_x5, _x6) {
