...
function _readOnlyError(r) { throw new TypeError('"' + r + '" is read-only'); } //voy a importar el jsonwebtoken para acceder a los metodos
...
var verifyToken = exports.verifyToken = function verifyToken(req, res, next) {
  ...
  if (token.startsWith('Bearer ')) {
    token.slice(7, token.length), _readOnlyError("token");
  }
  try {
...
var isModerator = exports.isModerator = /*#__PURE__*/function () {
  ...
  return function isModerator(_x, _x2, _x3) {
