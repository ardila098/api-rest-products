...
var productsCrtl = _interopRequireWildcard(require("../controllers/products.controller"));
...
router.post("/", _upload["default"], productsCrtl.createProduct);
router.get("/", productsCrtl.getProducts);
router.get("/:productId", productsCrtl.getProductById);
router.put("/:productId", _upload["default"], productsCrtl.updateProductById);
